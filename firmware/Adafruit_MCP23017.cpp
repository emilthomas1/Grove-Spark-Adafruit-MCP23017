 ...
 */
void Adafruit_MCP23017::setGPIOPinMode(char bank, uint8_t pin, uint8_t mode) {
 ...
 */
void Adafruit_MCP23017::setGPIOPullUp(char bank, uint8_t pin, uint8_t mode) {
 ...
 */
uint8_t Adafruit_MCP23017::readGPIOPin(char bank, uint8_t pin) {
  return bitRead(readGPIOBank(bank), pin);
}
 ...
 */
uint8_t Adafruit_MCP23017::readGPIOBank(char bank) {
 ...
 */
uint16_t Adafruit_MCP23017::readAllGPIO() {
  uint16_t result = 0;
 ...
 */
void Adafruit_MCP23017::writeGPIOPin(char bank, uint8_t pin, uint8_t value) {
 ...
 */
void Adafruit_MCP23017::writeAllGPIO(uint16_t value) {
 ...
 */
void Adafruit_MCP23017::writeGPIOBank(char bank, uint8_t value) {
